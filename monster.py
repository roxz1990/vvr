...
TOKEN = '7716572295:AAFpccfGH4dCUhrXZN9k1AqJ2JTHlGCTGzo'
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀 ⚔️ ᴷᵃʳᵃᵗ ᵏᵃʳᵃᵗ ᶜʰᵘᵈᵃⁱ ˢᵉ ˡᵘⁿᵈ ʰᵒᵃᵗ ᵇᵃˡʷᵃⁿ....ᶜʰᵘᵗ ᵐᵉ ᵃʷᵃᵗ ʲᵃᵃᵗ ˢᵉ ˡᵘⁿᵈ ᵇᵃⁿᵉ ᵐᵃʰᵃᵃⁿ😁 🚀*\n\n"  # Attack launched message
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 ●ᴷᵃˡ ᶜʰᵒᵈᵉ ˢᵒ ᵃᵃʲ ᶜʰᵒᵈ ᵃᵃʲ ᶜʰᵒᵈᵉ ˢᵒ ᵃᵇ! ᴸᵃᵈᵏⁱ ᵗᵒ ᶜʰᵘᵈᵗⁱ ʳᵃʰᵉᵍⁱ ᴮᴳᴹᴵ ᴷᴬ ˢᴱᴿⱽᴱᴿ ᶜᴴᴼᴰᴱᴳᴬ ᴷᴬᴮ?🤣* 🎉\n\n"
